...
public class DBAeroport extends DBObject<Aeroport> {
    ...
    /**
     * Initiate the connection to the database for the table "aeroport". This class
    ...
    /**
     * Return a constructed {@link com.brestats.model.data.Aeroport Aeroport} object
     ...
     *             </li>
     *             <li>{@link String <span style="color: blue">String</span>}
     *             adresse</li>
     *             <li>{@link com.brestats.model.data.Departement
     *             <span style="color: blue">Departement</span>} dep</li>
     *             </ul>
     * @return The initialised {@link com.brestats.model.data.Aeroport Aeroport}
     *         object
    ...
    public void insertQuery(Aeroport obj) {
        ...
        if (this.getItem(obj.getId()) == null) {
            ...
            query = "UPDATE annee SET adresse = " + obj.getAdresse() + ", leDepartement = " + obj.getDep().getIdDep()
