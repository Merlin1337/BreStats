...
public class DBGare extends DBObject<Gare> {
     ...
     * This class require the connection to the table "commune", while it has
    ...
    /**
     * Return a constructed {@link com.brestats.model.data.Gare Gare} object from
     * the query's result through a {@link String String[]} argument
     * 
     ...
     *                                      arguments
     * @see com.brestats.model.data.Gare#Gare(int, String, Commune, boolean,
     *      boolean)
     */
    ...
    public void insertQuery(Gare obj) {
        ...
        if (this.getItem(obj.getId()) == null) {
            query = "INSERT INTO annee VALUES (" + obj.getCodeGare() + "," + obj.getNomGare() + "," + obj.getEstFret()
                    + "," + obj.getEstVoyageur() + "," + obj.getCom().getIdCommune() + ";";
        } else {
            query = "UPDATE annee SET nomgare = " + obj.getNomGare() + ", estFret = " + obj.getEstFret()
                    + ", estVoyageur = " + obj.getEstVoyageur() + ", laCommune = " + obj.getCom().getIdCommune()
                    + "WHERE code = " + obj.getCodeGare() + ";";
        }
