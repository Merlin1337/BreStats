...
public class DBValeursCommuneAnnee extends DBObject<DonneesAnnuelles> {
    ...
    /**
     * Initiate the connection to the database for the table "donnnesannuelles".
     * This class require the connection to the tables "commune" and "annee", while
     * it has references to these objects.
     * 
    ...
    /**
     * Return a constructed {@link com.brestats.model.data.DonneesAnnuelles
     * DonneesAnnuelles} object from the query's result through a {@link String
     * String[]} argument
     * 
     * @param args The {@link String String[]} argument which contains all the
     *             required data to initiate the object.
     *             <ul>
     *             <li>{@link com.brestats.model.data.Commune
     *             <span style="color: blue">Commune</span>} com</li>
     *             <li>{@link com.brestats.model.data.Annee
     *             <span style="color: blue">Commune</span>} annee</li>
     ...
     *             <li><span style="color: blue">double</span> depCulturellesTotales
     *             </li>
     *             <li><span style="color: blue">double</span> budgetTotal</li>
     *             <li><span style="color: blue">double</span> pop</li>
     *             </ul>
     * @return The initialised {@link com.brestats.model.data.DonneesAnnuelles
     *         DonneesAnnuelles} object
     * @throws IncorectConstructorArguments if args does not contains the right
     *                                      arguments
     * @see com.brestats.model.data.DonneesAnnuelles#DonneesAnnuelles(Commune,
     *      Annee, int, int, double, double, double, double, double, double)
     */
    protected DonneesAnnuelles constructor(String[] args) throws IncorectConstructorArguments {
        ...
        if (args.length == 10) {
            try {
                ...
                ret = new DonneesAnnuelles(com, annee, nbMaison, nbAppart, prixMoyen, prixM2Moyen, surfaceMoy,
                        depCulturellesTotales, budgetTotal, pop);
    ...
    public void insertQuery(DonneesAnnuelles obj) {
        ...
        if (this.getItem(obj.getId()) == null) {
            ...
            query = "UPDATE annee SET nbMaison = " + obj.getNbMaison() + ", nbAppart = " + obj.getNbAppart()
                    ...
                    + obj.getPopulation() + " WHERE lAnnee = " + obj.getLAnnee().getAnnee() + " AND laCommune = "
                    + obj.getLaCom().getIdCommune() + ";";
        }
    ...
    /**
     * Caculate and return a {@code DonneesAnnuelles} object with average of all
     * available years for given city. This object has an {@link Annee} object with
     * 0 in its both fields.
     * 
    ...
    public DonneesAnnuelles getAverageItemByCity(Commune city) {
        ...
        try {
            ArrayList<DonneesAnnuelles> res = this
                    .selectQuery("SELECT * FROM donneesannuelles WHERE laCommune = " + city.getId() + ";");
            ...
            System.out.println("Unexpected exception with query : SELECT * FROM donneesannuelles WHERE laCommune = "
                    + city.getId() + "; \nReturn null.");
            e.printStackTrace();
        }
