 ...
 * {@link com.brestats.model.dao.DBObject#constructor(String[]) constructor}
 * method has not the correct arguments in the String[] argument.
 * 
...
public class IncorectConstructorArguments extends Exception {
    /**
     * Initiate an instance of the exception, calling the constructor of
     * {@link Exception}
     * 
     * @param m the message
     */
